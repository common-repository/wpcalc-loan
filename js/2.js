...
function considerResult(){
	...
	stoimkv=Number(document.forms.mainform["stoimkv"].value.replace(/\s/g, '',",","."));
	firstpay=Number(document.forms.mainform["firstpay"].value.replace(/\s/g, '',",","."));
	a=stoimkv-firstpay;
