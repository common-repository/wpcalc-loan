...
<div class="wpcalc-col-4"><b><?php esc_attr_e("Cost of apartments", "wpcalc-loan") ?>: </b></div><div class="wpcalc-col-4"><input type="text" name="stoimkv" value="<?php echo get_option('stoimkv'); ?>" size=4 onkeyup="considerResult();this.value = (this.value.replace(/\s*/g,'')).replace(/(\d)(?=(\d\d\d)+([^\d]|$))/g, '$1 ');"></div>
</div>

<div class="wpcalc-col">
<div class="wpcalc-col-4"><b><?php esc_attr_e("Down payment", "wpcalc-loan") ?>:</b></div><div class="wpcalc-col-4"><input type="text" name="firstpay" value="<?php echo get_option('firstpay'); ?>" size=4 onkeyup="considerResult();this.value = (this.value.replace(/\s*/g,'')).replace(/(\d)(?=(\d\d\d)+([^\d]|$))/g, '$1 ');"></div>
</div>

<div class="wpcalc-col">
<div class="wpcalc-col-4"><b><?php esc_attr_e("Credit term", "wpcalc-loan") ?>:</b></div><div class="wpcalc-col-4"><input type="text" name="term" value="<?php echo get_option('term2'); ?>" size=4 onkeyup="considerResult()"></div><div class="wpcalc-col-4"><select name="vremya" onclick="considerResult()" onkeyup="considerResult()"><option id="mes" value="1"> <?php esc_attr_e("months", "wpcalc-loan") ?> </option><option id="god" value="2"> <?php esc_attr_e("years", "wpcalc-loan") ?> </option></select></div>
</div>

<div class="wpcalc-col">
<div class="wpcalc-col-4"><b><?php esc_attr_e("Interest rate", "wpcalc-loan") ?>:</b></div><div class="wpcalc-col-4"><input  type="text" name="percent" size=4 value="<?php echo get_option('percent2'); ?>" onkeyup="considerResult()"></div><div class="wpcalc-col-4"><select name="nachisl" onclick="considerResult()" onkeyup="considerResult()"><option id="vmes" value="1">% <?php esc_attr_e("in year", "wpcalc-loan") ?></option><option id="vgod" value="2">%  <?php esc_attr_e("per month", "wpcalc-loan") ?> </option></select></div>
</div>
